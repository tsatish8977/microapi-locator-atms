...
/**
 * Test class for LocatorAtmsResource
 * 
 * @author Satish Kumar T
 *
 */
@ExtendWith(SpringExtension.class)
public class LocatorAtmsResourceTest {
	@SpyBean
	...
	void init() throws IOException {
		...
		doReturn(atmLocatorsList).when(locatorAtmsService).findAllAtms();
		doReturn(atmLocatorsList).when(locatorAtmsService).findAllAtmsByCity("city eq 'Den Oever'");
	}
